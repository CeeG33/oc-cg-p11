...
class TestPurchasePlaces:
    ...
    def test_cannot_purchase_in_past_competition(self, client, monkey_clubs, monkey_competitions):
        places_booked = 5
        data = {
...
class TestBook:
    ...
    def test_booking_in_past_competition_is_impossible(self, client, monkey_clubs, monkey_competitions):
        competition = "Fall Classic"
        club = "Simply Lift"
